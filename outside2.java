...
public class outside2 extends JFrame {
	 ...
	 */
	public outside2() throws InterruptedException, UnsupportedAudioFileException, IOException, LineUnavailableException {
		...
		mao.setOpaque(false);
		mao.setBounds((int)(width*0.825), (int)(height*0.52),(int)(width/9), height/4);
		...
		Image backgroundimg = toolkit.getImage("images/outside2.png");
